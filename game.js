...
startTimer();
const platforms = [
        { x: 200, y: 0, width: 20, height: 300, color: 'green' },
        { x: 500, y: 0, width: 20, height: 440, color: 'green' },
        { x: 200, y: 300, width: 100, height: 20, color: 'green' },
        { x: 400, y: 300, width: 400, height: 20, color: 'green' },
        { x: 0, y: 800, width: 20, height: 620, color: 'green' },
        { x: 1140, y: 800, width: 20, height: 620, color: 'green' },
        { x: 300, y: 300, width: 20, height: 500, color: 'green' },
        { x: 500, y: 500, width: 20, height: 300, color: 'green' },
        { x: 400, y: 800, width: 750, height: 20, color: 'green' },
        { x: 0, y: 800, width: 320, height: 20, color: 'green' },
        { x: 700, y: 1420, width: 460, height: 20, color: 'green' },
        { x: 800, y: 300, width: 20, height: 500, color: 'green' },
        { x: 600, y: 520, width: 20, height: 200, color: 'green' },
        { x: 700, y: 1420, width: 20, height: 100, color: 'green' },
        { x: 600, y: 1420, width: 20, height: 300, color: 'green' },
        { x: 700, y: 1500, width: 600, height: 20, color: 'green' },
        { x: 700, y: 1700, width: 600, height: 20, color: 'green' },
        { x: 500, y: 1700, width: 100, height: 20, color: 'green' },
        { x: 500, y: 1700, width: 20, height: 300, color: 'green' },
        { x: 800, y: 1700, width: 20, height: 300, color: 'green' },
        { x: 840, y: 0, width: 20, height: 620, color: 'green' },
        { x: 1980, y: 0, width: 20, height: 620, color: 'green' },
        { x: 840, y: 0, width: 1160, height: 20, color: 'green' },
        { x: 840, y: 620, width: 560, height: 20, color: 'green' },
        { x: 1500, y: 620, width: 500, height: 20, color: 'green' },
        { x: 1300, y: 620, width: 20, height: 900, color: 'green' },
        { x: 1500, y: 620, width: 20, height: 200, color: 'green' },
        { x: 1500, y: 800, width: 400, height: 20, color: 'green' },
        { x: 1900, y: 800, width: 20, height: 1000, color: 'green' },
        { x: 1300, y: 1000, width: 400, height: 20, color: 'green' },
        { x: 1700, y: 1000, width: 20, height: 600, color: 'green' },
        { x: 1300, y: 1600, width: 20, height: 200, color: 'green' },
        { x: 1300, y: 1800, width: 620, height: 20, color: 'green' },
        { x: 200, y: 0, width: 300, height: 20, color: 'green' },
        { x: 0, y: 1420, width: 600, height: 20, color: 'green' }

];

   const objects = [
    { x: 650, y: 400, width: 30, height: 30, color: 'yellow', type: 'key' },
    { x: 1500, y: 1200, width: 30, height: 30, color: 'yellow', type: 'key' },
    { x: 320, y: 800, width: 80, height: 20, color: 'brown', type: 'door' },
    { x: 1600, y: 820, width: 20, height: 180, color: 'brown', type: 'door' },

    { x: 620, y: 1700, width: 100, height: 20, color: 'purple', type: 'masterDoor' },
    { x: 1000, y: 330, width: 30, height: 30, color: 'orange', type: 'masterKey' },
    { x: 300, y: 1000, width: 30, height: 30, color: '#7AE1FF', type: 'sword' },
...
const boxes = [
    { x: 520, y: 450, width: 50, height: 50, color: 'blue', grabRange: 20 },
    { x: 1500, y: 900, width: 50, height: 50, color: 'blue', grabRange: 20 }
];
...
if (!quedanJefesActivos(currentBossRoom)) {
    ...
    currentBossRoom.doors.forEach(door => {
